...
// STEVE CHANGE TEMP
	luaL_Reg libs[] = {
		{ "colorMaskLib", ColorMaskLib },
		{ "depthLib", DepthLib },
		{ "instancingLib", InstancingLib },
		{ "stencilLib", StencilLib },
	...
	{
		lua_pushcfunction( L, libs[i].func ); // ..., libFactory
		lua_call( L, 0, 1 ); // ..., lib
		lua_setglobal( L, libs[i].name ); // ...; _G.name = lib
	}
// /STEVE CHANGE TEMP
