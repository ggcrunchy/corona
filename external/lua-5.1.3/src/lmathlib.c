...
static int math_abs (lua_State *L) {
  // lua_pushnumber(L, fabs(luaL_checknumber(L, 1))); /* LNUM */
/* LNUM */
#ifdef LNUM_COMPLEX
...
static int math_sin (lua_State *L) {
  // lua_pushnumber(L, sin(luaL_checknumber(L, 1))); /* LNUM */
/* LNUM */
#ifdef LNUM_COMPLEX
...
static int math_sinh (lua_State *L) {
  // lua_pushnumber(L, sinh(luaL_checknumber(L, 1))); /* LNUM */
/* LNUM */
#ifdef LNUM_COMPLEX
...
static int math_cos (lua_State *L) {
  // lua_pushnumber(L, cos(luaL_checknumber(L, 1))); /* LNUM */
/* LNUM */
#ifdef LNUM_COMPLEX
...
static int math_cosh (lua_State *L) {
  // lua_pushnumber(L, cosh(luaL_checknumber(L, 1))); /* LNUM */
/* LNUM */
#ifdef LNUM_COMPLEX
...
static int math_tan (lua_State *L) {
  // lua_pushnumber(L, tan(luaL_checknumber(L, 1))); /* LNUM */
/* LNUM */
#ifdef LNUM_COMPLEX
...
static int math_tanh (lua_State *L) {
  // lua_pushnumber(L, tanh(luaL_checknumber(L, 1))); /* LNUM */
/* LNUM */
#ifdef LNUM_COMPLEX
...
static int math_asin (lua_State *L) {
  lua_pushnumber(L, asin(luaL_checknumber(L, 1))); /* LNUM */
/* LNUM */
#ifdef LNUM_COMPLEX
...
static int math_acos (lua_State *L) {
  lua_pushnumber(L, acos(luaL_checknumber(L, 1))); /* LNUM */
/* LNUM */
#ifdef LNUM_COMPLEX
...
static int math_atan (lua_State *L) {
  lua_pushnumber(L, atan(luaL_checknumber(L, 1))); /* LNUM */
/* LNUM */
#ifdef LNUM_COMPLEX
...
static int math_ceil (lua_State *L) {
  // lua_pushnumber(L, ceil(luaL_checknumber(L, 1))); /* LNUM */
/* LNUM */
#ifdef LNUM_COMPLEX
...
static int math_floor (lua_State *L) {
  // lua_pushnumber(L, floor(luaL_checknumber(L, 1))); /* LNUM */
/* LNUM */
#ifdef LNUM_COMPLEX
  lua_Complex v = luaL_checkcomplex(L, 1);
...
static int math_sqrt (lua_State *L) {
  // lua_pushnumber(L, sqrt(luaL_checknumber(L, 1))); /* LNUM */
/* LNUM */
#ifdef LNUM_COMPLEX
...
static int math_pow (lua_State *L) {
  // lua_pushnumber(L, pow(luaL_checknumber(L, 1), luaL_checknumber(L, 2))); /* LNUM */
/* LNUM */
#ifdef LNUM_COMPLEX
...
static int math_log (lua_State *L) {
  // lua_pushnumber(L, log(luaL_checknumber(L, 1))); /* LNUM */
/* LNUM */
#ifdef LNUM_COMPLEX
...
static int math_log10 (lua_State *L) {
  // lua_pushnumber(L, log10(luaL_checknumber(L, 1))); /* LNUM */
/* LNUM */
#ifdef LNUM_COMPLEX
...
static int math_exp (lua_State *L) {
  // lua_pushnumber(L, exp(luaL_checknumber(L, 1))); /* LNUM */
/* LNUM */
#ifdef LNUM_COMPLEX
...
static int math_frexp (lua_State *L) {
  int e;
  lua_pushnumber(L, _LF(frexp)/*frexp*/(luaL_checknumber(L, 1), &e)); /* LNUM */
  lua_pushinteger(L, e);
  return 2;
}

static int math_ldexp (lua_State *L) {
  lua_pushnumber(L, _LF(ldexp)/*ldexp*/(luaL_checknumber(L, 1), luaL_checkint(L, 2))); /* LNUM */
  return 1;
}
...
LUALIB_API int luaopen_math (lua_State *L) {
  ...
  lua_pushnumber(L, PI);
  lua_setfield(L, -2, "pi");
  lua_pushnumber(L, HUGE/*_VAL*/); /* LNUM */
